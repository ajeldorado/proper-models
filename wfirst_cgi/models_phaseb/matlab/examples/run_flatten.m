...
% addpath(genpath('~/Downloads/phaseb_data/'))
...
EE = prop_run(['wfirst_phaseb' ], lam_array, npsf, 'quiet', 'passvalue',optval );

% after flattening

optval.dm1_m = fitsread(['errors_polaxis10_dm.fits']);
optval.use_dm1 = 1;
Ef = prop_run(['wfirst_phaseb' ], lam_array, npsf, 'quiet', 'passvalue',optval );
...
optval.polaxis = 0;
optval.source_x_offset = 7.0;
EE0 = prop_run(['wfirst_phaseb_compact'  ], lam_array, npsf, 'quiet', 'passvalue',optval );
