...
% disp('changed, potentially wrong')
        mp.P1.compact.Nbeam = 300; %% wavefront.diam/wavefront.dx
...
% mp.full.cor_type = 'vortex'; 
    mp.full.map_dir = 'C:\Users\matnoyes\Documents\Projects\HCIT_Camilo\DST2\DST2_PROPER_Models\maps\';	%-- directory containing optical surface error maps
    mp.full.gridsize = 2048; % # of points across in PROPER model 
...
mp.full.use_dm1 = 1;                %   use DM1? 1 or 0
mp.full.use_dm2 = 1;                %   use DM2? 1 or 0
...
mp.full.flagPROPER = true; %--Whether the full model is a PROPER prescription
    mp.full.prescription = 'DST2';
% mp.full.cor_type = 'vortex'; 
    mp.full.map_dir = 'C:\Users\matnoyes\Documents\Projects\HCIT_Camilo\DST2\Maps\OAP_FITS\';	%-- directory containing optical surface error maps
    mp.full.gridsize = 2048; % # of points across in PROPER model 
    mp.full.beam_ratio = 0.25;
