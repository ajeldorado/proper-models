...
def run_spc_ifs():
    ...
    (fields, sampling) = proper.prop_run_multi('wfirst_phaseb', lam, n, QUIET=True, \
        PASSVALUE={'cor_type':'spc-ifs','lam0':lam0,'use_errors':0,'zindex':[4],'zval_m':[0.19e-9],'final_sampling_lam0':final_sampling} )
    ...
    (fields, sampling) = proper.prop_run_multi('wfirst_phaseb_compact', lam, n, QUIET=True, \
        PASSVALUE={'cor_type':'spc-ifs','lam0':lam0,'source_x_offset':7.0,'final_sampling_lam0':final_sampling} )
