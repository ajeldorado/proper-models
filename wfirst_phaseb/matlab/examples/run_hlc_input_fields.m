...
EE = prop_run_multi(['wfirst_phaseb'], lam_array, n, 'quiet', 'passvalue',optval );
...
optval.use_fpm = 0;
fld = prop_run_multi(['wfirst_phaseb'], lam_array, n, 'quiet', 'passvalue',optval );
...
Ee = prop_run_multi(['wfirst_phaseb_compact'], lam_array, n, 'quiet', 'passvalue',optval ); 
...
EE0 = prop_run_multi(['wfirst_phaseb_compact'], lam_array, n, 'quiet', 'passvalue',optval );
