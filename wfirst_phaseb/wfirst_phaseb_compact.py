...
def wfirst_phaseb_compact( lambda_m, output_dim, PASSVALUE={'dummy':0} ):
    ...
    if cor_type == 'hlc':
        ...
        # these commented-out DM values are for the testbed, not flight
